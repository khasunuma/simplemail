...
import jp.yumix.simplemail.session.GmailProviderTest;
import jp.yumix.simplemail.session.ICloudProviderTest;
import jp.yumix.simplemail.session.OutlookProvider;
import jp.yumix.simplemail.session.SessionProvider;

public class OutlookMailTest {

    private static final String propFileURL = "/testuser.outlook.properties";
